...
Let us see how to use resume module under phlagrant in the upcoming topics.

Help Command
--------------------

The help command explains the users regarding the major role of this module under phlagrant box, list of alternative parameters that can used for declaring, the syntax for using the resume function under phlagrant box. The command for implementing the help action under resume module is shown below,

.. code-block:: bash

		phlagrant resume help
...
.. code-block:: bash
	...
	phlagrant resume virtualbox -- yes --guess

After entering the command as given above, the user can select and start resuming a work in virtual box.

The following screenshot depicts the methodologies of using this module for resuming a phlagrant box.
