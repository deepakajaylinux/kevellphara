...
This function aims at listing all the autopilot files in your specified location(build/config/cleopatra/autopilots). The syntax for applying this function is shown below,
...
This function assists in creating a default set of cleopatra autopilots (in build/config/cleopatra/autopilots) for the project of the users. This function can be applied simply by using the command below,
...
This function aims at creating a default set of cleopatra autopilots (in build/config/cleopatra/autopilots) for a project with tiny infrastructure. To implement this functions use the following command as below,
...
This function aims at creating a default set of cleopatra autopilots (in build/config/cleopatra/autopilots) for a project with medium infrastructure. To implement this functions use the following command as below,
...
This function aims at creating a default set of cleopatra autopilots (in build/config/cleopatra/autopilots) for a project with medium infrastructure with web, but not database. To implement this functions use the following command as below,
...
This function aims at creating a default set of cleopatra autopilots (in build/config/cleopatra/autopilots) for the users project. 
