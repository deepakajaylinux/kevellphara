...
Installation includes installation of Oracle required to make the installation in an updated version. It is a manifest process to install Oracle module under Cleopatra Oracle by just using the command given below,

.. Code-block:: bash

	cleopatra Oracle Install
...
.. code-block:: bash
 ...
 kevell@corp:/# cleopatra Oracle install
 Install Oracle? (Y/N) 
 y
 *******************************
 *        Pharaoh Tools        *
 *         Oracle!        *
 *******************************
 Creating /tmp/cleopatra-temp-script-74494590076.sh
 chmod 755 /tmp/cleopatra-temp-script-74494590076.sh 2>/dev/null
 Changing /tmp/cleopatra-temp-script-74494590076.sh Permissions
 Executing /tmp/cleopatra-temp-script-74494590076.sh
 ...
 Temp File /tmp/cleopatra-temp-script-74494590076.sh Removed
...
.. cssclass:: table-bordered
 ...
 +================================+=====================================+=================+===========================================+
 |Install Oracle?(Y/N)		  | Instead of using Oracle we can use  | Y		  | It will install  Oracle under cleopatra   |
