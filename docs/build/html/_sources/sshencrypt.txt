...
The help command guides the user to handle key in cleopatra. This help command guides the user to install sshencrypt. This also unencrypt the key.  Encryption can be used to protect data "at rest", such as files on computers and storage devices. In recent years there have been numerous reports of confidential data such as customers' personal records being exposed through loss or theft of laptops or backup drives. The help command for Sshencrypt is shown below.


.. code-block:: bash

		cleopatra  sshencrypt help
...
.. code-block:: bash
 ...
 kevell@corp:/# cleopatra SshEncrypt help
...
There are many alternatives available in sshencrypt. Each alternative shows an added advantages to this modules.  They are,
SshEncrypt, ssh-encrypt, sshencrypt.
