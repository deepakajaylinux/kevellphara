...
.. code-block:: bash
 ...
 kevell@corp:/# cleopatra DigitalOcean help
 ******************************
...
.. code-block:: bash
	...
	cleopatra digital-ocean box-add
                    --yes
                    --digital-ocean-ssh-key-path="/home/dave/.ssh/bastion.pub"
                    --digital-ocean-ssh-key-name="bastion"
...
.. code-block:: bash
	...
	cleopatra digital-ocean box-destroy --yes --guess --digital-ocean-ssh-key-path="/home/dave/.ssh/bastion.pub" 
        --digital-ocean-ssh-key-name="bastion"
...
.. code-block:: bash
	...
	cleopatra digital-ocean box-destroy-all --yes --guess
...
.. code-block:: bash
	...
	cleopatra digital-ocean save-ssh-key
                    --yes
                    --digital-ocean-ssh-key-path="/home/dave/.ssh/bastion.pub"
                    --digital-ocean-ssh-key-name="bastion"
...
.. code-block:: bash
	...
	cleopatra digital-ocean list

Or

.. code-block:: bash

        cleopatra digital-ocean list --yes
                    --guess # use project saved connection details if possible
                    --type=sizes # droplets, sizes, images, domains, regions, ssh_keys
