...
.. code-block:: bash
		...
		cleopatra PHPMD help

The following screen shot vizualize its functions.

.. code-block:: bash

 kevells@corp:/# cleopatra PHPMD help
 ******************************
...
.. code-block:: bash
 ...
 kevells@corp:/# cleopatra phpmd install
 ...
 *******************************
 ...
 git clone 'https://github.com/phpengine/cleopatra-phpmd.git'  /tmp/phpmd/phpmdCloning into '/tmp/phpmd/phpmd'...
...
.. cssclass:: tabe-bordered
 ...
 +=============================+==========================+=====================+==============================================+
 |Data directory (Default)     | Yes			  | “/opt/PHPMD”	| It will install PHPMD module under cleopatra |
 +-----------------------------+--------------------------+---------------------+----------------------------------------------+
