...
-----------
 ...
 PhpSSH has now become even easier to get it up and running. Making it much easier to auto upgrade Cleopatra via PhpSSH. Taking remote shell, 
...
.. code-block:: bash
 ...
 kevell@corp:/# cleopatra PHPSSH help
 ******************************
...
.. code-block:: bash
 ...
 kevell@corp:/# cleopatra phpssh install
 Install PHP SSH? (Y/N)
 Y
 *******************************
 *        Pharaoh Tools        *
