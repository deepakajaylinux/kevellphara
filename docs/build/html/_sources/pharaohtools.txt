...
The Pharaoh tool module assists in installing Dapperstrano, Testingamen, Jrush, generating Cleopatra reports. It facilitates the users to ensure the availability before installations. Only missing modules can be installed specifically.

Help Command
-------------

The help command guides the users about how to make use of this particular module under Cleopatra.
...
.. code-block:: bash
 ...
 kevell@corp:/# cleopatra PharaohTools help
 ******************************
...
.. code-block:: bash
		...
		cleopatra pharaoh-tools install
...
.. code-block:: bash
 ...
 root@udayakumar:/# cleopatra pharaoh-tools install
 ...
 *******************************
 ...
 [Pharaoh Logging] Ensure module install is not checking versions
 [Pharaoh Logging] Module Testingkamen reports itself as Installed
 [Pharaoh Logging] Not installing as already installed
 [Pharaoh Logging] Ensure module install is not checking versions
 [Pharaoh Logging] Module Cleopatra reports itself as Installed
 [Pharaoh Logging] Not installing as already installed
 [Pharaoh Logging] Ensure module install is not checking versions
...
.. cssclass:: table-bordered
 ...
 +=======================+===================================+===============+==========================================================+
 |Program data           | "/opt/testingkamen		     | Yes	     | If the user to proceed installation with the default     |
...
.. code-block:: bash
 ...
 kevell@corp:/# cleopatra pharaoh-tools install
 Install Pharaoh Tools? (Y/N) 
 Y
 *******************************
 *        Pharaoh Tools        *
