...
.. code-block:: bash
 ...
 kevells@corp:/# cleopatra sftp help
 ******************************
...
As a company, and as individuals, SFTP has been dedicated to meeting each partner’s technology challenges, fulfilling their engineering requirements, and satisfying their business goals. It is an obvious process to install SFTP module under Cleopatra by just using the command given below,
...
.. code-block:: bash
 ...
 kevell@corp:/# cleopatra sftp put
